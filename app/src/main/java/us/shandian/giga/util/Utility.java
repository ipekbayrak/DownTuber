...
import com.kardelenapp.downtuber.DownTuberSettings;
import com.kardelenapp.downtuber.R;
...
public class Utility
{
	...
	public static boolean isDownloadDirectoryAvailble(Context context) {
		return isDirectoryAvailble(DownTuberSettings.getVideoDownloadPath(context));
	}
